    ...
    return (
        <div className="single-blog">
            <div className="mb-5">
                <img
                    src={coverImage}
                    className="w-[800px] h-full rounded"
                    alt=""
                    srcset=""
                />
            </div>
            <div className="blog-inner-content md:px-2 px-1">
                ...
                <div>
                    ...
                    <h4 className="text-right">
                        ...
                        <span
                            className="md:pl-3 pl-3 cursor-pointer"
                            onClick={() => bookmarkLength(props.blog)}
                        >
            ...
            <div className="mt-5 ml-2">
                ...
                <div className="flex gap-5">
                    ...
                    <p className="text-gray-500 pt-5">#Design</p>
                </div>
                <p
                    onClick={() => markAsRead(props.blog)}
                    className="underline text-blue-600 cursor-pointer mt-5"
                >
                    Mark As Read
                </p>
            </div>
